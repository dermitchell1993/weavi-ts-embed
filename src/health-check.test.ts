...
describe('health-check', () => {
  ...
  describe('waitForReady', () => {
    ...
    it('should retry until Weaviate becomes ready', async () => {
      ...
      await waitForReady(8080, 5000, 50);
    ...
    it('should timeout after specified duration', async () => {
      ...
      await expect(waitForReady(8080, 100, 20)).rejects.toThrow(
        'Weaviate failed to start within 100ms. Check logs for errors.'
      );
    });
    ...
    it('should use custom timeout and retry interval', async () => {
      ...
      // Use a short timeout for faster test execution
      await expect(waitForReady(8080, 150, 50)).rejects.toThrow(
        'Weaviate failed to start within 150ms. Check logs for errors.'
      );
    });
    ...
    it('should respect timeout parameter', async () => {
      ...
      await expect(waitForReady(8080, 200, 50)).rejects.toThrow(
        'Weaviate failed to start within 200ms. Check logs for errors.'
      );
    });
